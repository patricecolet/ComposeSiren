...
HeadComponent::HeadComponent()
{
  ...
  labelPluginTitle.setFont (juce::FontOptions (24.0f, juce::Font::italic));
  ...
  imgLogo = ImageFileFormat::loadFrom(BinaryData::Picto_Siren_40x37_png, BinaryData::Picto_Siren_40x37_pngSize);
...
{
    //mainCommands.removeListener(this);
    //mixer.removeListener(this);
